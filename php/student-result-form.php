...
<head>
    <title>HKBKCE- Check Your Results Here</title>

    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta http-equiv="X-UA-Compatible" content="IE=7" />
    <link rel="shortcut icon" href="../assets/logo and favicon/HKBK_Logos_2013_with_out_KSMF.webp" type="image/x-icon" />
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="../index.html">
            <img class="logo-one" src="../assets/logo and favicon/HKBK_Logos_2013_with_out_KSMF.webp" alt="Navbar logo" />
        </a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <a href="../index.html">
                            <img class="logo2" src="../assets/logo and favicon/HKBK_Logos_2013_with_out_KSMF.webp" alt="logo2" />
                        </a>
                        <p class="content1">
                        Welcome to an institution dedicated to creating tomorrow’s leaders and today’s pioneers. 
                        Located in Bangalore, India’s most beautiful, exciting and happening city, 
                        just a short trip of 7km from MG Road will bring you to a wonderful campus that
                         inspires students to succeed professionally and personally in a competitive world.
                            <br /><br />
